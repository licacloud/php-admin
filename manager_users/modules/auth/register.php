...
if(isPost()){
    ...
    if(empty($errors)){
        ...
        if($insertStatus){
            ...
            // Thiet lap gui mail
            $subject = $filterAll['fullname']. ' Vui long kich hoat tai khoan!!';
            $content = 'Chao'.$filterAll['fullname'].'.</br>';
            $content .= 'Vui long click vao link duoi day de kich hoat tai khoan: </br>';
            ...
            // die();
            if($senMail){
                setFlashData('smg',"Dang ky thanh cong, vui long kiem tra email de kich hoat tai khoan!!");
                setFlashData('smg_type',"success");
            }else{
                setFlashData('smg',"He thong dang gap su co, vui long thu lai sau!!");
                setFlashData('smg_type',"success");
            }
        }else{
            setFlashData('smg',"Dang ky khong thanh cong!!");
...
<div class="row">
    <div class="col-4" style="margin: 50px auto;">
        <h2 class="text-center text-uppercase">Dang ky tai khoan Users</h2>
        <?php
        if(!empty($smg)){
            getSmg($smg, $smg_type);
        }
        ...
        <form action="" method="post">
            ...
            <button type="submit" class="btn btn-primary btn-block mg-form mg-btn">Dang ky</button>
            <hr>
